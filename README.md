...
This was the output. Tx for telling which layers to use ;-)
...
Actually this function is called two times. One time by the test procedure and a second time before training. When the entire graph was build i could find the layers in the loaded vgg model.
